...
extern char input_message[MAX_MSG_LEN];

extern WINDOW *msg_win, *user_win, *input_win;
extern WINDOW *msg_win_border, *user_win_border, *input_win_border;
extern int msg_win_height, msg_win_width;
extern int user_win_height, user_win_width;
extern int input_win_height, input_win_width;

extern int msg_scroll_pos;
extern int user_scroll_pos;
extern int active_window; // 0 - msg_win, 1 - user_win
